...
st.markdown("**Analyzing Democratic State and County Vote Share Trends | 2016-2020**")
...
of the county-level data.
        ...
        st.info("Select a state from the dropdown above to see county-level results.")